  ...
  return (
    <div className='my-24 md:px-14 px-4 max-w-screen-2xl mx-auto' id="feature">
        <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
            ...
            <h3 className='text-3xl text-primary font-bold lg:w-1/2 mb-3'>Why we are better than
            others</h3>
            ...
            <div className='bg-[rgba(255,255,255,0.04)] rounded-[35px] h-96 shadow-2xl p-8 cursor-pointer 
                ...
                <div className='bg-[rgba(255,255,255,0.04)] rounded-[35px] h-96 shadow-2xl p-8 cursor-pointer md:mt-16 
                items-center flex justify-center  hover:-translate-y-4 transition-all duration-300 '>
                    <div>
                        <img src={featureimg} />
                        <h5 className='text-2xl font-semibold text-primary px-5 text-center'>Conventient study schedule</h5>
